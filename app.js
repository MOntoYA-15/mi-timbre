...
auth.onAuthStateChanged(user => {
    if (user) {
        ...
        // OJO: aquí NO se limpia error-msg. Si se limpiara aquí, el mensaje
        // de "cuenta no autorizada" desaparecería de inmediato, porque
        // auth.signOut() dispara este mismo bloque justo después de mostrarlo.
        // El mensaje se limpia solo cuando el usuario intenta loguearse de nuevo
        // (ver handleLogin).
    }
});
